        ...
        <div class="basic-info">
          <el-form label-width="120px">
            ...
            <el-form-item label="违约方">
              <el-radio class="radio" v-model="form.breachRadio" label="1">我方</el-radio>
              <el-radio class="radio" v-model="form.breachRadio" label="2">对方</el-radio>
              <el-radio class="radio" v-model="form.breachRadio" label="3">双方</el-radio>
            </el-form-item>
